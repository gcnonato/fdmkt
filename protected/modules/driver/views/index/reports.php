    ...
    <div class="row">
      ...
      <div class="col-md-9">
         ...
         <div class="col-md-3 col-xs-offset-5">
	         <div class="btn-group">
	            <a href="javascript:;" data-id="time" class="btn btn-primary change_charts"><?php echo t("Time")?></a>
	            <a href="javascript:;" data-id="agent" class="btn btn-primary change_charts"><?php echo t("Agent")?></a>
	         </div>
	     </div>    
         </div>
