  ...
  ?>  
   ...
   <?php foreach ($list['PICKUP'] as $key=>$val):?>
    <tr>
     ...
     getOptionA("PICKUP_".$val[0])==1?true:false
     ,array('class'=>"switch-boostrap"))?></td>
     
     <td><?php echo CHtml::checkBox("PICKUP_".$val[1],
     getOptionA("PICKUP_".$val[1])==1?true:false
     ,array('class'=>"switch-boostrap"))?></td>
     
     <td><?php echo CHtml::checkBox("PICKUP_".$val[2],
     getOptionA("PICKUP_".$val[2])==1?true:false
     ,array('class'=>"switch-boostrap"))?></td>
   ...
   <tbody>
     ...
     getOptionA("ASSIGN_TASK_SMS")==1?true:false
      ,array('class'=>"switch-boostrap"))?>
     </td>
     <td>
     ...
     getOptionA("UPDATE_TASK_SMS")==1?true:false
      ,array('class'=>"switch-boostrap"      
      ))?>
     </td>
     <td>
     ...
     getOptionA("CANCEL_TASK_PUSH")==1?true:false
      ,array('class'=>"switch-boostrap"))?>
     </td>
     <td>
     <?php echo CHtml::checkBox('CANCEL_TASK_SMS', 
     getOptionA("CANCEL_TASK_SMS")==1?true:false
      ,array('class'=>"switch-boostrap"      
      ))?>
     </td>
     <td>
     <?php echo CHtml::checkBox('CANCEL_TASK_EMAIL', 
     getOptionA("CANCEL_TASK_EMAIL")==1?true:false
      ,array('class'=>"switch-boostrap",'disabled'=>true))?>
     </td>
   ...
   <tbody>
     ...
     getOptionA("FAILED_AUTO_ASSIGN_SMS")==1?true:false
      ,array('class'=>"switch-boostrap",'disabled'=>true))?>
     </td>
     <td>
     ...
     getOptionA("AUTO_ASSIGN_ACCEPTED_PUSH")==1?true:false
      ,array('class'=>"switch-boostrap",'disabled'=>false))?>
     </td>
     <td>
     <?php echo CHtml::checkBox('AUTO_ASSIGN_ACCEPTED_SMS', 
     getOptionA("AUTO_ASSIGN_ACCEPTED_SMS")==1?true:false
      ,array('class'=>"switch-boostrap",'disabled'=>true))?>
     </td>
     <td>
     <?php 
     echo CHtml::checkBox('AUTO_ASSIGN_ACCEPTED_EMAIL', 
     getOptionA("AUTO_ASSIGN_ACCEPTED_EMAIL")==1?true:false
      ,array('class'=>"switch-boostrap",'disabled'=>true))?>
     </td>
