...
/**
 *   Last Update : 1.0.0 
 *   Last Update : 1.1.0 - July 3, 2016
 *   Last Update : 1.2.0 - July 10, 2016
 */
class DriverModule extends CWebModule
{
	...
	public function init()
	{
		...
		/*MAP MARKER*/
		$delivery_icon=Yii::app()->baseUrl.'/protected/modules/driver/assets/images/delivery-pending-task.png';
		$pickup_icon=Yii::app()->baseUrl.'/protected/modules/driver/assets/images/pickup-pending.png';
		$driver_icon=Yii::app()->baseUrl.'/protected/modules/driver/assets/images/human-location-white.png';
		$driver_icon_offline=Yii::app()->baseUrl.'/protected/modules/driver/assets/images/driver-icon-32.png';
		
		$delivery_icon_successful=Yii::app()->baseUrl.'/protected/modules/driver/assets/images/delivery-successful.png';
		$delivery_icon_failed=Yii::app()->baseUrl.'/protected/modules/driver/assets/images/delivery-failed-task.png';
		$pickup_icon_ok=Yii::app()->baseUrl.'/protected/modules/driver/assets/images/pickup-successful.png';
