    ...
    <?php if ( getOptionA('merchant_reg_abn')=="yes"):?>
     ...
     <div class="row top10">
      ...
      <div class="row top10">
        ...
        <div class="col-md-8">
        <?php echo CHtml::dropDownList('state', isset($data['state'])?$data['state']:"", array('San José' => 'San José', 'Alajuela' => 'Alajuela', 'Heredia' => 'Heredia', 'Cartago' => 'Cartago', 'Puntarenas' => 'Puntarenas', 'Guanacaste' => 'Guanacaste', 'Limón' => 'Limón'), array('empty' => '(Seleccioná tu provincia)','data-validation'=>"required"))?>
