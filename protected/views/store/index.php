...
<script type="text/javascript">
        ...
        //window.onload = aviso;
		setTimeout(aviso,7000);
</script>
<div id="aviso" style="display:none;">
    <center>
    <b>¡Lanzamiento: 15 de abril de 2017!</b> <br />
    Mientras tanto, nos encontramos en reclutamiento de <br /> artesanos culinarios emprendedores.<br />
     <a href="https://www.fmarket.org/store/merchantsignupselection"><img src="<?php echo assetsURL()."/images/avisorecluta.png"?>"><br />
    Clic aquí para formar parte ahora.</a>
    </center>
</div>
<!--AVISO RECLUTAMIENTO-->
 ...
 <div class="row">
   <div class="col-md-3 col-sm-3 center">
      <div class="steps step1-icon">
        <a href="https://www.fmarket.org/store/browse"><img src="<?php echo assetsURL()."/images/step1.png"?>"></a>
      </div>
      <a href="https://www.fmarket.org/store/browse"><h3>1. <?php echo t("Search")?></h3></a>
      <p><a href="https://www.fmarket.org/store/browse"><?php echo t("Find all restaurants available near you")?></a></p>
   </div>
   <div class="col-md-3 col-sm-3 center">
      <div class="steps step2-icon">
         <img src="<?php echo assetsURL()."/images/step2.png"?>">
      </div>
      <h3>2. <?php echo t("Choose")?></h3>
