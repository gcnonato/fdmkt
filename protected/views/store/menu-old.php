  ...
  <div class="restaurant-wrap">
    <div class="uk-grid">
      ...
      <div class="uk-width-1-3">
        ...
        <?php echo Yii::app()->functions->translateDate(date('F d l')."@".timeFormat(date('Y-m-d H:i:s'),true));?>
        </p>                
        <?php endif;?>
    ...
    <div class="order-list-wrap scroll-child2">
      ...
      <?php if (yii::app()->functions->validateSellLimit($merchant_id) ):?>
         ...
         <?php else :?>
            ...
            <p><?php echo Yii::app()->functions->translateDate(date('F d l')."@".timeFormat(date('Y-m-d H:i:s'),true));?></p>
            <?php endif;?>
         <?php endif;?>
      <?php else :?>
