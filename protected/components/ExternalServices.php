	 ...
	 public function getCart()
	 {
      ...
      <?php if (yii::app()->functions->validateSellLimit($merchant_id) ):?>
         ...
         <?php else :?>
            ...
            <p><?php echo prettyDate(date('Y-m-d H:i:s'),true);?></p>
            <?php endif;?>
         <?php endif;?>
      <?php else :?>
...
if (empty($receipt_subject)){	
	$receipt_subject="Tu orden ha sido confirmada";
}
...
if (!in_array($data['order_id'],(array)$_SESSION['kr_receipt'])){	
    ...
    if ( $enabled_alert_notification==""){    	
    	sendEmail($merchant_notify_email,$receipt_sender,Yii::t("default","Nueva orden de ").$data['full_name'],$tpl);
    }   
